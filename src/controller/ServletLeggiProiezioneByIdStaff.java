...
@WebServlet("/ServletLeggiProiezioneByIdStaff")
public class ServletLeggiProiezioneByIdStaff extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(!isStaff(request)) {
			...
			request.getRequestDispatcher("/WEB-INF/jsp/staff-modifica-proiezione.jsp").forward(request, response);
		}
