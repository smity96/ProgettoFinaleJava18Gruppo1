...
<link rel="stylesheet"
	href="..\css\fontawesome-free-5.15.0-web\css\all.min.css">
			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav links d-md-none">
					...
					<li class="nav-item d-flex align-items-center my-3">
						...
						<div class="col-9 ml-3">
							<a class="nav-link active"
								href="/ProgettoFinaleJava18Gruppo1/html/profiloUtente.jsp">Gestione
								Profilo</a>
						</div>
					</li>
					<li class="nav-item d-flex align-items-center my-3">
						...
						<div class="col-9 ml-3">
							<a class="nav-link active"
								href="/ProgettoFinaleJava18Gruppo1/html/prenotaUtente.jsp">Gestione
								Prenotazione</a>
						</div>
					</li>
				</ul>
				...
				<ul class="navbar-nav icons align-items-center">
					<li class="nav-item mr-5"><a class="navbar-brand py-3"
						href="#"> <img src="../src/logocinema.png"
							class="img-fluid rounded-circle img-thumbnail mr-3" alt="Logo"
							style="width: 40px;" /> Nome Utente
					</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="modal"
						data-target="#sign-out" href="#"> <i class="fa fa-sign-out"></i>
							Sign Out
					</a></li>
				</ul>
			</div>
			...
			<nav
				...
				<ul class="navbar-nav flex-column">
					<li class="nav-item d-flex align-items-center my-3">
						...
						<div class="col-9 ml-3">
							<a class="nav-link active"
								href="/ProgettoFinaleJava18Gruppo1/html/index.jsp">Torna
								alla Home</a>
						</div>
					</li>
					<li class="nav-item d-flex align-items-center my-3">
					...
					<li class="nav-item d-flex align-items-center my-3">
						...
						<div class="col-9 ml-3">
							<a class="nav-link active"
								href="/ProgettoFinaleJava18Gruppo1/html/prenotaUtente.jsp">Prenota
								film</a>
						</div>
					</li>
					<li class="nav-item d-flex align-items-center my-3">
						...
						<div class="col-9 ml-3">
							<a class="nav-link active"
								href="/ProgettoFinaleJava18Gruppo1/html/gestionePrenotaUtente.jsp">Gestione
								Prenotazioni</a>
						</div>
					</li>
			</nav>
